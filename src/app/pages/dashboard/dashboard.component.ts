...
import {device, DeviceInterface,account} from "./devices/interfaces/device.interface";
...
export class DashboardComponent implements OnDestroy , OnInit {
   ...
   god(type) : void
  {
    ...
    switch (type)
    {
      ...
      case 4:
        ...
        break;
      case 5:
        this.defaultSetting(2);
        this.title_of_table="compte avec du blocage";
        this.source=this.bloqued_account;
        break;
      case 6:
        this.defaultSetting(6);
        this.title_of_table="Total des boitiers jamais envoyé";
        this.source=this.device_neverSend;
        break;
    }
  ...
  nbr_compte_avec_blocage: CardSettings = {
    title: 'Total des compte avec blocage',
    iconClass: 'nb-danger',
    type: 'danger',
    nbr:0,
    t:5
  };
  nbr_neverSendDevices: CardSettings = {
    title: 'Total des boitiers jamais envoyé',
    iconClass: 'nb-shuffle',
    type: 'danger',
    nbr:0,
    t:6
  };
  ...
  [
    ...
    this.nbr_compte_avec_blocage,
    this.nbr_neverSendDevices
  ];
  ...
  device_neverSend:device[];
  source:Array<any>=[]
  bloqued_account:account[];
  constructor(private themeService: NbThemeService,private dialogService: NbDialogService,
    ...
    this.deviceService.getDeviceInfoData().then(data=>
    {
      ...
      this.deviceService.getBloqued_devices().subscribe(d=>
      {
        ...
        this.deviceService.getBloqued_account().subscribe(a=>
        {
          this.bloqued_account = a;
          ...
          this.deviceService.getDesabonned_devices().subscribe(d=>
          {
            ...
            this.deviceService.getFonctionnel_devices().subscribe(d=>
            {
              this.device_fonctionnel=d;
               this.deviceService.getNeverSend_Devices().subscribe(d=> {
                 this.device_neverSend=d;
                ...
                this.nbr_compte_avec_blocage.nbr = data.account_bloqued;
                this.nbr_neverSendDevices.nbr = data.neverSend;
                this.is_loaded = true;
              });
    ...
    else if(type==2)
    {
      ...
      this.settings = {
        ...
        columns: {
          ...
          nbr_device: {
            title: 'NOMBRE DE BOITIER BLOQUER',
            type: 'number',
          },
        },
        attr: {
