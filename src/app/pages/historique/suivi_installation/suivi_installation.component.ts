...
@Component({
  selector: 'ngx-suivi_installation',
  templateUrl: 'suivi_installation.component.html',
  styleUrls: ['suivi_installation.component.scss'],
})

export class Suivi_installationComponent {
